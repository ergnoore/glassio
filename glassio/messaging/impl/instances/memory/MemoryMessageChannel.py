...
__all__ = [
    "MemoryMessageChannel",
]


class MemoryMessageChannel(InitializableMessageChannel, AbstractInitializableComponent):
    ...
    def __init__(
        self,
        queue: PriorityQueue,
        message_type_matcher: IMessageTypeMatcher[MemoryMessageChannelProperties],
        logger: ILogger,
    ...
    async def _initialize(self) -> None:
        ...
        self.__background_task = self.__event_loop.create_task(
            ...
            name="MemoryMessageChannel publishing task."
        )
    ...
    async def __publish(
        ...
        self.__event_loop.create_task(
            confirming_wrapper(),
            name=f"MemoryMessageChannel consumer: `{consumer}`."
        )
